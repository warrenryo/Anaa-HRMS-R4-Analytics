<x-app-layout>
    <div class="panel">
        <div class="flex justify-end">
            <button type="button"
                class=" py-3 px-4  gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
            ...
            <div
                ...
                <div
                    ...
                    <div class="p-4 overflow-y-auto">
                        <form action="{{ url('submit-item') }}" method="POST">
                            @csrf
                            <div>
                                <label for="ctnSelect1">Category</label>
                                <select id="ctnSelect1" name="category" class="form-select text-white-dark" required>
                            ...
                            <div class="relative mt-4">
                                <input type="text" name="item_name" id="floating_outlined"
                                    class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=" " />
                                <label for="floating_outlined"
                                    class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">Item
                                    Name</label>
                            </div>

                            <!-- Input Number -->
                            <div class="mt-4 py-2 px-3 bg-white border border-gray-200 rounded-lg dark:bg-slate-900 dark:border-gray-700"
            ...
            <table>
                ...
                <tbody>
                    @foreach ($item as $items)
                        <tr>
                            <td>{{ $items->r4_category_name }}</td>
                            <td>{{ $items->r4_item_name }}</td>
                            <td>
                                <div class="hs-tooltip inline-block [--trigger:hover] mr-2">
                                    <button type="button" data-hs-overlay="#edit-item{{ $items->id }}"
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <button type="button"
                                                    class="flex justify-center items-center size-7 text-sm font-semibold rounded-full border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                                    data-hs-overlay="#edit-item{{ $items->id }}">
                                                    <span class="sr-only">Close</span>
                                            ...
                                            <div class="p-4 overflow-y-auto">
                                                <form action="{{ url('update-item/id=' . $items->id) }}"
                                                    method="POST">
                                                    @method('PUT')
                                                    @csrf
                                                    <div>
                                                        <label for="ctnSelect1">Category</label>
                                                        <select id="ctnSelect1" name="category"
                                                            class="form-select text-white-dark" required>
                                                            <option>Select Maintenance Category</option>
                                                            @foreach ($category as $cat)
                                                                <option value="{{ $cat->category_name }}"
                                                                    {{ $cat->category_name == $items->r4_category_name ? 'selected' : '' }}>
                                                    ...
                                                    <div class="relative mt-4">
                                                        <input type="text" name="item_name"
                                                            value="{{ $items->r4_item_name }}" id="floating_outlined"
                                                            class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                                            placeholder=" " />
                                                        <label for="floating_outlined"
                                                            class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">Item
                                ...
                                <!--DELETE -->
                                <div class="hs-tooltip inline-block [--trigger:hover] mr-2">
                                    <button type="button" data-hs-overlay="#delete-item{{ $items->id }}"
                                        class="hs-tooltip-toggle flex justify-center items-center h-10 w-10 text-sm font-semibold rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                                        ...
                                        <div
                                            ...
                                            <div class="absolute top-2 end-2">
                                                <button type="button"
                                                    ...
                                                    data-hs-overlay="#delete-item{{ $items->id }}">
                                                    <span class="sr-only">Close</span>
                                                    <svg class="flex-shrink-0 size-4"
                                                        xmlns="http://www.w3.org/2000/svg" width="24"
                                                        height="24" viewBox="0 0 24 24" fill="none"
                                                ...
                                                <div class="flex gap-x-4 md:gap-x-7">
                                                    ...
                                                    <div class="grow">
                                                        ...
                                                        <p class="text-gray-500">
                                                            Permanently remove this {{ $items->r4_item_name }} and all
                                                            of its contents from the ANAA HOTEL RESTAURANT INVENTORY.
                                            ...
                                            <div
                                                ...
                                                <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-red-500 text-white hover:bg-red-600 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                                    href="{{ url('delete-item/id=' . $items->id) }}">
                                                    Delete Item
                                                </a>
                                            </div>
                                        </div>
