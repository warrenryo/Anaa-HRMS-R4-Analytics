                                        ...
                                        <li class="nav-item">
                                            <a href="{{ url('inventory_stocks') }}" class="group">
                                                <div class="flex items-center">
                                                    ...
                                                    <span
                                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Restaurant
                                                        stocks</span>
                                                </div>
                                            </a>
                                        </li>
                                                ...
                                                <li class="menu nav-item">
                                                    <button type="button" class="nav-link group"
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <svg class="group-hover:!text-primary" width="20"
                                                    ...
                                                    <ul x-cloak x-show="activeDropdown === 'reports'" x-collapse
                                                        ...
                                                        <li>
                                                            <a href="{{ url('complete-transaction') }}">Complete Transaction</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <h2
                                                    ...
                                                    <span>STRIPE API PAYMENTS</span>
                                                </h2>
                                                <li class="nav-item">
                                                    <a href="{{ url('stripe-payments') }}" class="group">
                                                        <div class="flex items-center">
                                                            <svg width="24" height="24" viewBox="0 0 24 24"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path
