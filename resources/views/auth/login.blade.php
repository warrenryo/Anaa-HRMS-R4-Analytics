<x-guest-layout>
    ...
    <div class="flex min-h-screen">
        <div
            ...
            <div class="w-full mx-auto mb-5"><img src="/assets/images/anaalogo2.png" alt="coming_soon"
        ...
        <div class="w-full lg:w-1/2 relative flex justify-center items-center">
            ...
            <a href="{{ url('/analytics') }}"
                class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">go back to Analytics</a>
            @else
